...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        num_iterations->setObjectName("num_iterations");
        num_iterations->setGeometry(QRect(620, 280, 101, 24));
        num_iterations->setMaximum(10000000);
